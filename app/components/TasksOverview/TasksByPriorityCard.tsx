...
export default function TasksByPriorityCard({ tasks }: { tasks: Task[] }) {
  ...
  return (
    <section
      className={`flex flex-col gap-3 p-2 ${theme === "Light" ? "bg-bg-surface border-border-color" : "bg-bg-surface-dark border-border-color-dark"} border rounded-btn hover:shadow-lg duration-200`}
    >
